	...
	const keyboard = {
		inline_keyboard: [
			...
			[
				...
				{ text: '❌ Закрити', callback_data: 'help_close'}
			]
		],
	};

	const reply = `✻ *Вітаю!* Я — *Флюксі*, твій помічник у повсякденних справах. 🤖\n
	📚 _Оберіть категорію нижче, щоб отримати допомогу по командах._\n
	⚡ Я можу керувати завданнями, створювати цілі, генерувати зображення та багато іншого!`;
